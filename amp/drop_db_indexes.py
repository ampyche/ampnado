...
class DropDBIndexes():
	...
	def drop_tempalbumView_index(self): viewsdb.tempalbumView.drop_indexes()
	
	def drop_tempartistView_index(self): viewsdb.tempartistView.drop_indexes()
	...
	def drop_tempTags_index(self): db.tempTags.drop_indexes()

	def drop_tempVideo_index(self): db.tempVideo.drop_indexes()
...
class DropDBs():
	...
	def rm_db_initalbView(self): viewsdb.initalbView.remove({})

	def rm_db_initartView(self): viewsdb.initartView.remove({})

	def rm_db_initsongView(self): viewsdb.initsongView.remove({})
	...
	def rm_db_tempalbumView(self): viewsdb.tempalbumView.remove({})

	def rm_db_tempartistView(self): viewsdb.tempartistView.remove({})
	...
	def rm_db_tempTags(self): db.tempTags.remove({})
	
	def rm_db_tempVideo(self): db.tempVideo.remove({})
